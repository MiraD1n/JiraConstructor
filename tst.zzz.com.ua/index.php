...
<button type="submit">Инциденты в JIRA</button>
  </form>

  *** Алерты за период времени в Zabbix ***
  <form action = "zabbix_alerts.php" method="post">
  Hours from: <select id="hour_from" name="hour_from">
    <option>00</option>
    <option>01</option>
    <option>02</option>
  ...
  Dates to: &nbsp; <input type="date" id="date_to" name="date_to"/>
  <button type="submit">Инциденты в Zabbix</button>
    </form>
